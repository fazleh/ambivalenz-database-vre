...
def normalize_neo4j_value(value):
    """
    Normalize string values coming from Neo4j:
...
def neo4j_safe_prop(prop: str) -> str:
    """
    Convert human-readable property names to Neo4j-safe keys
    """
    return (
        prop.strip()
            .replace(" ", "_")
...
def get_field_list():
    ...
    return [
        ...
        "Objekt- oder Werkteil", "Rechte / Lizenzen", "Digitalisat_Link_Pfad",
